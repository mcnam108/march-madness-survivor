...
const T = {
  ...
  "Prairie View":{s:16,r:"South",k:160,aO:155,aD:158,em:-5.5,pa:"fast",oI:"trans",dI:"man-std",mo:"hot",inj:[]},
};

const DAYS = [
  { id:1, label:"Day 1 — Round of 64", date:"Thu, Mar 19", games:[
    {a:"Ohio State",b:"TCU"},{a:"Duke",b:"Siena"},{a:"Louisville",b:"South Florida"},{a:"Michigan St",b:"N. Dakota St"},
    {a:"Nebraska",b:"Troy"},{a:"Vanderbilt",b:"McNeese"},{a:"North Carolina",b:"VCU"},{a:"Illinois",b:"Penn"},
    {a:"Saint Mary's",b:"Texas A&M"},{a:"Houston",b:"Idaho"},{a:"Michigan",b:"Howard"},{a:"Georgia",b:"Saint Louis"},
    {a:"Wisconsin",b:"High Point"},{a:"Arkansas",b:"Hawaii"},{a:"BYU",b:"Texas"},{a:"Gonzaga",b:"Kennesaw St"},
  ]},
  { id:2, label:"Day 2 — Round of 64", date:"Fri, Mar 20", games:[
    {a:"St. John's",b:"N. Iowa"},{a:"Kansas",b:"Cal Baptist"},{a:"UCLA",b:"UCF"},{a:"UConn",b:"Furman"},
    {a:"Texas Tech",b:"Akron"},{a:"Alabama",b:"Hofstra"},{a:"Tennessee",b:"Miami OH"},{a:"Virginia",b:"Wright St"},
    {a:"Kentucky",b:"Santa Clara"},{a:"Iowa St",b:"Tenn St"},
    {a:"Arizona",b:"LIU"},{a:"Villanova",b:"Utah St"},{a:"Miami FL",b:"Missouri"},{a:"Purdue",b:"Queens"},
    {a:"Florida",b:"Prairie View"},{a:"Clemson",b:"Iowa"},
  ]},
  { id:3, label:"Day 3 — Round of 32", date:"Sat, Mar 21", games:[] },
  { id:4, label:"Day 4 — Round of 32", date:"Sun, Mar 22", games:[] },
  { id:5, label:"Day 5 — Sweet 16", date:"Thu, Mar 26", games:[] },
  { id:6, label:"Day 6 — Sweet 16", date:"Fri, Mar 27", games:[] },
  { id:7, label:"Day 7 — Elite 8 ★", date:"Sat–Sun, Mar 28–29", games:[], combined:true, note:"Combined pool: pick from any E8 game" },
  { id:8, label:"Day 8 — Elite 8 ★", date:"Sat–Sun, Mar 28–29", games:[], combined:true, note:"Combined pool: pick from any E8 game" },
